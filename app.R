...
con<- odbcDriverConnect(connection = "Driver=FreeTDS;TDS_Version=7.2;Server=cmserv.database.windows.net;Port=1433;Database=cm;Uid=utkuco;Pwd=Utku-coskun1;Encrypt=no;TrustServerCertificate=no;Connection Timeout=30;")
